  ...
  onLoad: function (options) {
    wx.showLoading({
      ...
      wx.request({
        ...
        data: {
          collect: 1,
          titlename: app.globalData.staffshow1.username
        },
        success: (res) => {
          this.setData({
            staffmyarticles: res.data,
            attentionsrc: app.globalData.staffshow1.usersrc,
            attentionname: app.globalData.staffshow1.username
          })
        },
        fail: (res) => {
          wx.showToast({
      ...
      wx.request({
        ...
        data: {
          collect: 2,
          collectname: app.globalData.staffshow1.username
        },
        success: (res) => {
          this.setData({
